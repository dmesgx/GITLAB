...
void main()
{
  int WinLotteryNo[10] = {1524, 1758, 5515, 7235, 5614, 8876, 1215, 4232, 9155, 9995}; 
  float WinAmount[10] = {70000, 2000, 10000, 5000, 5000, 5000, 5000, 3000, 3000, 3000};
  int N = 10;
  int i, won; 
  
  int YourLotteryNo;  
   
  printf("Enter Lottery Number (0 to end): "); 
